                ...
                <div className="p-1">
                  ...
                  <div className="p-4">
                    <div className="space-y-4">
                      <div className="bg-syinq-lightgray p-4 rounded-xl flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-1">
                            ...
                            <div className="flex">
                              {[1, 2, 3, 4, 5].map((star) => (
                                <svg key={star} className="w-3 h-3 text-yellow-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="bg-gradient-to-r from-syinq-blue/5 to-syinq-green/5 p-4 rounded-xl">
                        <div className="flex justify-between items-center mb-3">
                          <p className="font-medium">Student Center → West Dorms</p>
