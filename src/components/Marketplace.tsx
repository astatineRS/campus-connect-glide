        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative reveal-on-scroll">
            <div className="relative grid grid-cols-2 gap-4">
              <div className="apple-card transform translate-y-12 hover:translate-y-10 transition-transform">
              ...
              <div className="apple-card hover:translate-y-2 transition-transform">
                <div className="w-full aspect-square bg-white rounded-lg shadow-sm mb-4 overflow-hidden flex items-center justify-center">
          ...
          <div className="space-y-8 reveal-on-scroll">
            ...
            <div className="mt-8">
              <button className="apple-button bg-syinq-green">Browse Marketplace</button>
            </div>
          </div>
        </div>
      </div>
