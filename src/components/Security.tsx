  ...
  return <section id="security" className="bg-syinq-lightgray relative overflow-hidden py-0">
      ...
      <div className="section-container">
        ...
        <div className="relative max-w-4xl mx-auto reveal-on-scroll">
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-24 h-24 lg:w-32 lg:h-32 bg-syinq-blue/10 rounded-full flex items-center justify-center">
